...
- 💼 **Education:** Studying Mechatronics Engineering.
- ⚡ **R&D Focus:** Electronics R&D, IoT, embedded systems & hardware/software integration.
- 🪙 **Web3:** Building dApps, smart contracts, and decentralized architectures.
- 🕹️ **Game Dev & Scripting:** Developing custom game scripts, automation tools, and modding frameworks.
- 🛠️ **Simulation & CAD:** 3D Modeling (SolidWorks) & Finite Element Analysis (Ansys).
